      ...
      <div className="mx-auto w-[min(72rem,calc(100%-2rem))]">
        ...
        <div className="mt-14 grid items-stretch gap-6 md:grid-cols-2">
          ...
          >
            ...
            <div className="mt-6 rounded-xl bg-void/60 p-4 font-mono text-xs leading-6 text-ink-dim">
              <p>
                <span className="text-neon-green">$</span> neo dev
              </p>
              <p className="text-neon-green">
                ⟳ watching… changes sync both ways
              </p>
              <p>
                <span className="text-neon-green">$</span> claude &quot;add a quest
                chain for the rat king&quot;
              </p>
              <p className="text-ink-dim">
                agent edits neo/Schema/Save.cs → <span className="text-neon-green">neo push ✓</span>
              </p>
            </div>
          </motion.div>
